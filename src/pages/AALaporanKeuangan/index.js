...
export default function AALaporanKeuangan({ navigation, route }) {
    ...
    return (
        <SafeAreaView style={{
            ...
            <TouchableOpacity
                onPress={() => navigation.navigate('AALaporanKeuanganHeader')}
                style={{
                ...
                <Icon type='ionicon' name='bar-chart-outline' size={100} color={colors.white} />
                <Text style={{
                    fontFamily: fonts.secondary[600],
                    fontSize: 20,
                    color: colors.white
                }}>LAPORAN SUMMARY</Text>

            </TouchableOpacity>

            <TouchableOpacity
                onPress={() => navigation.navigate('AALaporanKeuanganDetail')}
                style={{
                    height: windowHeight / 3,
                ...
                <Icon type='ionicon' name='file-tray-full-outline' size={100} color={colors.white} />
                <Text style={{
                    fontFamily: fonts.secondary[600],
                    fontSize: 20,
                    color: colors.white
