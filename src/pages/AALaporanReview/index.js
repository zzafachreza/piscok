...
export default function AALaporanReview({ navigation, route }) {
    ...
    useEffect(() => {
        setKirim({
            ...
            penjualan_nontunai: ((kirim.qris * 3500) + (kirim.grab_gojek * 3500) + (kirim.reseller * 3500) + parseFloat(kirim.tarik_tunai)) - parseFloat(kirim.tunai_qris),
            penjualan_tunai: (add.jumlah * 3500) - (((kirim.qris * 3500) + (kirim.grab_gojek * 3500) + (kirim.reseller * 3500) + parseFloat(kirim.tarik_tunai)) - parseFloat(kirim.tunai_qris)) - add.total_beli,
            pembelian_outlet: add.total_beli,
            setoran_outlet: ((add.jumlah * 3500) - (((kirim.qris * 3500) + (kirim.grab_gojek * 3500) + (kirim.reseller * 3500) + parseFloat(kirim.tarik_tunai)) - parseFloat(kirim.tunai_qris)) - add.total_beli) + parseFloat(kirim.modal) + parseFloat(kirim.diskon_reseller)
        });
    }, [])
    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <MyList l='RESELLER x 3,500' v={new Intl.NumberFormat().format(kirim.reseller * 3500)} />
